...
namespace CocosNet.Support {
	...
	public class Texture2D : IDisposable {
		...
		public Texture2D(string text, string fontName, float fontSize) : this(text, text.SizeWithFont(UIFont.FromName(fontName, fontSize)), UITextAlignment.Center, fontName, fontSize) {
		}
